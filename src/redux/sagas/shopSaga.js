...
// import {
//   addShopSuccess,
//   clearSearchState, editShopSuccess, getShopsSuccess,
//   removeShopSuccess,
//   searchShopSuccess
...
function* shopSaga({ type, payload }) {
  ...
  switch (type) {
    case GET_USER_SHOP:
      try {
        const shopSnapshot = yield call(firebase.getUserShop, payload.shopId);
        if (shopSnapshot.data()){
          yield put(setShop(shopSnapshot.data()));
        }
      } catch (e) {
        yield handleError(e);
      }
